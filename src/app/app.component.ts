...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    var sType = domComps.getType('select');
    var sModel = sType.model;
    var sView = sType.view;
    ...
    domComps.addType('select', {
      model: sModel.extend({
        defaults: Object.assign({}, sModel.prototype.defaults, {
          traits: 
          dModel.prototype.defaults.traits.concat(
          sModel.prototype.defaults.traits.concat([
            'test'
          ])
        )
        })
